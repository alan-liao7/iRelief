...
export default class ProfileScreen extends React.Component {
  ...
  buttonPress2() {
    firebase
      .auth()
      .signInWithEmailAndPassword(this.state.firstname, this.state.lastname)
  ...
  signup() {
    ...
    firebase
      .auth()
      .createUserWithEmailAndPassword(this.state.firstname, this.state.lastname)
      .catch(function(error) {
        // Handle Errors here.
  ...
  render() {
    ...
    button = (
      <Button
        ...
        textStyle={styles.btnText}
        onPress={() => {
          reg ? this.buttonPress2() : this.buttonPress();
        }}
      />
    );
